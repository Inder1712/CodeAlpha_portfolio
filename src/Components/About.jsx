      ...
      <div className="h-fit w-[90%] bg-slate-950 shadow-md shadow-black">
        <div className="h-fit w-fit md:flex">
          <div className="flex p-10 h-fit w-fit ">
            <img
              src={profile}
              alt=""
              className="h-40 w-40 sm:h-60 sm:w-60 rounded-full bg-contain"
            />
          </div>
        ...
        <div className="h-fit w-full px-10 pb-10">
          ...
          <button
            ...
            className="bg-blue-500 rounded-xl mt-10 text-xl font-medium hover:bg-blue-400 hover:shadow-blue-500 shadow-sm shadow-blue-500/50 h-12 w-44"
          >
            Download Resume
          </button>
        </div>
